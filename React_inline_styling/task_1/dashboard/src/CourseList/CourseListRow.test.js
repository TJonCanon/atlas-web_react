...
describe('CourseListRow', () => {
  ...
  it('applies the correct style for a header row', () => {
    ...
    it('applies the correct style for a regular row', () => {
      const wrapper = shallow(<CourseListRow textFirstCell="Test" />);
      expect(wrapper.find('tr').hasClass('row')).toBe(true);
    });
    ...
    it('applies the correct style for a header cell', () => {
      const wrapper = shallow(<CourseListRow isHeader textFirstCell="Test" />);
      expect(wrapper.find('th').hasClass('th')).toBe(true);
      expect(wrapper.find('th').hasClass('headerTh')).toBe(true);
    });
  });